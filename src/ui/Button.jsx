...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    small:
      base +
      ringPlus +
      ' w-30 sm:w-36  px-4 py-2 md:px-5 md:py-2.5 text-sm sm:text-xs border-4 border-yellow-400',

    delete:
      deleteSpecial +
      ` py-2 md:px-5 md:py-2.5 border-4 border-red-400 text-sm sm:text-xs w-32 sm:w-36 focus:outline-none focus:ring focus:ring-red-400 focus:bg-red-300 focus:ring-offset-2 bg-gradient-to-l from-red-100 to-red-400 hover:bg-gradient-to-r from-red-100 to-red-400`,
